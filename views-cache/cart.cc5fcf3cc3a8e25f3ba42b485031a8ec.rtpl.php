                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remove Todos" class="remove" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                                        </td>
                                        ...
                                        <td class="product-price">
                                            <span class="amount">Akz <?php echo formatPrice($value1["vlprice"]); ?></span> 
                                        </td>
                                        ...
                                        <td class="product-subtotal">
                                            <span class="amount">Akz <?php echo formatPrice($value1["vltotal"]); ?></span> 
                                        </td>
                                    </tr>
                                    <?php } ?>
