<?php  
	...
	class Category extends Model
	{
		...
		public static function getPage($page = 1, $itemsPerPage = 10)
		{
			...
			$results = $sql->select("SELECT SQL_CALC_FOUND_ROWS * FROM tb_categories ORDER BY descategory
							LIMIT $start, $itemsPerPage");
		...
		public static function getPageSearch($search, $page = 1, $itemsPerPage = 10)
		{
			...
			$results = $sql->select("SELECT SQL_CALC_FOUND_ROWS * FROM tb_categories WHERE descategory LIKE :search ORDER BY descategory LIMIT $start, $itemsPerPage", [
				':search'=>'%'.$search.'%'
			]);
